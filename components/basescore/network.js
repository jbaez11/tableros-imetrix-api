...
router.get('/', function(req,res){ 
    const filterBasescore =  null;
    //const filterAgentsAudit2 = req.query.eventDate || null;
    console.log('filter agents ',filterBasescore)
    ...
    controller.getBasescore(filterBasescore,dbname)
    .then((asesoresList) => {
...
router.post('/', function(req,res){
    ...
    controller.addBasescore(req.body.infaltable,dbname)
        .then((fullBasescore) => {
...
router.patch('/:id', function(req,res){
    ...
    controller.updateBasescore(req.params.id, req.body.infaltable,dbname)
        .then((data) => {
