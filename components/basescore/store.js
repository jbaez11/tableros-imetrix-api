...
async function getBasescore(filterBasescore,nameDB){
    ...
    switch (nameDB) {
        ...
        case 'igsAlmacenesSI' :
            ...
            return basescore;
        case 'igsJelpitCO' :
            basescore = await basescoreIgsJelpitCOModel.find(filter);
            return basescore;
        case 'igsComfamiliarCO' :
            basescore = await basescoreIgsComfamiliarCO.find(filter);
            return basescore;
        case 'igsBancoAgricolaSV' :
            basescore = await basescoreIgsBancoAgricolaSVModel.find(filter);
            return basescore;
        case 'igsDaviviendaCR' :
            basescore = await basescoreIgsDaviviendaCRModel.find(filter);
            return basescore;    
