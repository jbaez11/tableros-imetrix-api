const { agentsSerFinanzaModel,agentsBancoColombiaModel,
     ...
     agentsIgsPromericaCOModel,agentsIgsBancolombiaAMModel,agentsIgsAlmacenesSIModel,
     agentsIgsJelpitCOModel,agentsIgsComfamiliarCOModel,agentsIgsBancoAgricolaSVModel,
     agentsIgsDaviviendaCRModel} = require('./model');
...
async function getAgents( nameDB){
    ...
    switch (nameDB) {
        ...
        case 'igsAlmacenesSI' :
            agents = await agentsIgsAlmacenesSIModel.find();
            return agents;
        case 'igsJelpitCO' :
            agents = await agentsIgsJelpitCOModel.find();
            return agents;
        case 'igsComfamiliarCO' :
            agents = await agentsIgsComfamiliarCOModel.find();
            return agents;
        case 'igsBancoAgricolaSV' :
            agents = await agentsIgsBancoAgricolaSVModel.find();
            return agents;
        case 'igsDaviviendaCR' :
            agents = await agentsIgsDaviviendaCRModel.find();
            return agents;    
...
function addAgents(agents,nameDB){
    ...
    switch (nameDB) {
        ...
        case 'igsBancolombiaAM' :
            ...
            return myAgents;
        case 'igsAlmacenesSI' :
            myAgents = new agentsIgsAlmacenesSIModel(agents);
            myAgents.save();
            return myAgents;
        case 'igsJelpitCO' :
            myAgents = new agentsIgsJelpitCOModel(agents);
            myAgents.save();
            return myAgents;
        case 'igsComfamiliarCO' :
            myAgents = new agentsIgsComfamiliarCOModel(agents);
            myAgents.save();
            return myAgents;
        case 'igsBancoAgricolaSV' :
            myAgents = new agentsIgsBancoAgricolaSVModel(agents);
            myAgents.save();
            return myAgents;
            
        case 'igsDaviviendaCR' :
            myAgents = new agentsIgsDaviviendaCRModel(agents);
            myAgents.save();
            return myAgents;
...
async function updateAgents(id,name,identification,gender,nameDB){
    ...
    switch (nameDB) {
        ...
        case 'igsBancolombiaAM' :
                ...
                return newAgents;
        case 'igsAlmacenesSI' :
                foundAgents = await agentsIgsAlmacenesSIModel.findOne({_id : id});
                foundAgents.name = name ;
                foundAgents.identification = identification ;
                foundAgents.gender = gender ;
        ...
        case 'igsJelpitCO' :
                foundAgents = await agentsIgsJelpitCOModel.findOne({_id : id});
                foundAgents.name = name ;
                foundAgents.identification = identification ;
                foundAgents.gender = gender ;
                ...
                return newAgents;
        case 'igsComfamiliarCO' :
                foundAgents = await agentsIgsComfamiliarCOModel.findOne({_id : id});
                foundAgents.name = name ;
                foundAgents.identification = identification ;
                foundAgents.gender = gender ;
                ...
                return newAgents;
        case 'igsBancoAgricolaSV' :
                foundAgents = await agentsIgsBancoAgricolaSVModel.findOne({_id : id});
                foundAgents.name = name ;
                foundAgents.identification = identification ;
                foundAgents.gender = gender ;
                ...
                return newAgents;
        case 'igsDaviviendaCR' :
                foundAgents = await agentsIgsDaviviendaCRModel.findOne({_id : id});
                foundAgents.name = name ;
                foundAgents.identification = identification ;
                foundAgents.gender = gender ;
...
function removeAgents(id,nameDB){
    ...
    switch (nameDB) {
        ...
        case 'igsAlmacenesSI' :
            return agentsIgsAlmacenesSIModel.deleteOne({_id:id});
        case 'igsJelpitCO' :
            return agentsIgsJelpitCOModel.deleteOne({_id:id});
        case 'igsComfamiliarCO' :
            return agentsIgsComfamiliarCOModel.deleteOne({_id:id});
        case 'igsBancoAgricolaSV' :
            return agentsIgsBancoAgricolaSVModel.deleteOne({_id:id});
        case 'igsDaviviendaCR' :
            return agentsIgsDaviviendaCRModel.deleteOne({_id:id});        
